...
public class Autorisation extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Autorisation frame = new Autorisation();
	...
	public Autorisation() {
		...
		frmtdtxtfldDocumentSigner.setBounds(255, 0, 85, 29);
		...
		frmtdtxtfldDate.setBounds(337, 0, 71, 29);
		panel_3.add(frmtdtxtfldDate);
		
		JFormattedTextField frmtdtxtfldRaison = new JFormattedTextField();
		frmtdtxtfldRaison.setText("Raison");
		frmtdtxtfldRaison.setFont(new Font("Tahoma", Font.BOLD, 11));
		frmtdtxtfldRaison.setBounds(406, 0, 71, 29);
		panel_2.add(frmtdtxtfldRaison);
		
		JFormattedTextField frmtdtxtfldDure = new JFormattedTextField();
		frmtdtxtfldDure.setText("Dur\u00E9e");
		frmtdtxtfldDure.setFont(new Font("Tahoma", Font.BOLD, 11));
		frmtdtxtfldDure.setBounds(473, 0, 71, 29);
		panel_2.add(frmtdtxtfldDure);
		...
		txtpnAttestation.setText("AUTORISATION");
